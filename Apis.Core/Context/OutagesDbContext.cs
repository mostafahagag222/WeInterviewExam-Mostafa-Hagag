    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CuttingDownA>(entity =>
        {
            ...
            entity.Property(e => e.PlannedEndDatetime)
                .HasColumnName("Planned_End_DTS");
            entity.Property(e => e.PlannedStartDatetime)
                .HasColumnName("Planned_Start_DTS");
            ...
            entity.HasOne(d => d.ProblemType).WithMany(p => p.CuttingDownAs)
        ...
        modelBuilder.Entity<CuttingDownB>(entity =>
        {
            ...
            entity.HasOne(d => d.ProblemType).WithMany(p => p.CuttingDownBs)
                .HasForeignKey(d => d.ProblemTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CuttingDownHeader>(entity =>
        {
            ...
            entity.HasOne(d => d.CuttingDownProblem).WithMany(p => p.CuttingDownHeaders)
